...
"https://cdn.shopify.com/s/files/1/0057/8938/4802/files/1_1.gif?v=1686650188","https://cdn.shopify.com/s/files/1/0057/8938/4802/files/AD_441_ANC.jpg?v=1686297917"]
...
for(src of product_img_src_link){
    ...
    const actual_price = Math.random() * (2500 - 1000) + 1000;
    const discounted_price =  Math.random() * (1500 - 1000) + 1000;
    ...
    let product_elem=`
    <div class="item">
        <button class="mycartbtn" onclick='showoption(this)'>click</button>
...
// display puschase div when hover


function showoption(parent){
